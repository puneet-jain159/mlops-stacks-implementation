...
[ML Config](../az_demo/resources/README.md)  guides to make changes to ML code or deployed jobs.
...
```
git add README.md docs .gitignore az_demo/resources/README.md
...
Follow the instructions in [az_demo/resources/README.md](../az_demo/resources/README.md) to deploy ML resources
and production jobs.
...
[ML pull request guide](ml-pull-request.md) and [ML resource config guide](../az_demo/resources/README.md)  to propose, test, and deploy
