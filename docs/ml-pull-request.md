...
Opening a pull request will trigger a[workflow](../.github/workflows/az_demo-run-tests-fs.yml) 
...
* [Staging workspace registered model](https://adb-984752964297111.11.azuredatabricks.net#mlflow/models/staging-az_demo-model)
* [Prod workspace registered model](https://adb-984752964297111.11.azuredatabricks.net#mlflow/models/prod-az_demo-model)
